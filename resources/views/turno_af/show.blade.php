...
@section('contenido')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">turno_af {{ $turno_af->id }}</div>
                    <div class="card-body">
                        ...
                        <a href="{{ url('/turno_af/' . $turno_af->id . '/edit') }}" title="Edit turno_af"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
