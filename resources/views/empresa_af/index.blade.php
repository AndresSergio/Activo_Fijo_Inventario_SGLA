                            ...
                            <table class="table">
                                ...
                                @foreach($empresa_af as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->estado }}</td>
                                        <td>
                                            <a href="{{ url('/empresa_af/' . $item->id) }}" title="View empresa_af"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                                            <a href="{{ url('/empresa_af/' . $item->id . '/edit') }}" title="Edit empresa_af"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
